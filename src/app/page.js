					...
					<div className="bg-slate-800 rounded-xl p-6 border border-slate-700 max-w-md mx-auto">
						...
						<div className="flex justify-center space-x-3 flex-wrap gap-2">
							<a
								...
								className="flex items-center px-3 py-2 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 rounded-lg text-white transition-colors">
								<Image
									src="/portfolio.svg"
									alt="Portfolio"
									className="mr-2"
