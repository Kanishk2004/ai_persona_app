            ...
            <div className="p-4">
              <div className="bg-gradient-to-r from-blue-900 to-purple-900 rounded-lg p-6 border border-slate-600">
                <div className="flex items-center space-x-4 mb-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-white">Kanishk Chandna</h3>
                    <p className="text-blue-300">Full Stack Developer & AI Enthusiast</p>
                  </div>
                </div>
                
                <p className="text-slate-300 mb-4">
                  Passionate about building modern web applications with AI integration. 
                  This chat app showcases the power of multiple AI personas and seamless user experience.
                </p>
        ...
        {!hasMessages && (
          ...
          >
            <div className="max-w-md mx-auto">
              ...
              <p className="text-slate-300 mb-4">
                Start a conversation with Hitesh Chaudhary or Piyush Garg. 
                Each persona has their unique expertise and personality!
              </p>
              <p className="text-slate-400 text-sm mb-6">
                Crafted with ❤️ by <span className="text-blue-400 font-medium">Kanishk Chandna</span> using Next.js, OpenAI, and Gemini AI.
              </p>
              <div className="bg-blue-900 border border-blue-700 rounded-lg p-4">
                <p className="text-sm text-blue-200">
                  💡 <strong>Tip:</strong> Try asking about web development, system design, 
                  or any technical topic to see how each persona responds differently!
                </p>
              </div>
            </div>
          </motion.div>
      ...
      <div className="p-4 bg-slate-800 border-t border-slate-700">
        <form onSubmit={handleSubmit} className="flex space-x-3">
          ...
          <motion.button
            ...
            whileHover={!inputMessage.trim() || isLoading ? {} : { scale: 1.02 }}
        ...
        <div className="flex items-center justify-between mt-2">
          <p className="text-xs text-slate-400">
            Current persona: <span className="font-medium text-slate-300">{currentPersona}</span>
          </p>
